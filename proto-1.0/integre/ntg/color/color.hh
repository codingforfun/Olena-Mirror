...
namespace ntg {
  ...
  */
  ...
  template <typename E>
  struct color_value: public vect_value<E>
  {};

  namespace internal {

    template <class E>
    struct typetraits<color_value<E> > : public typetraits<vect_value<E> >
    {};
  ...
  template <unsigned ncomps,
	    unsigned qbits,
	    template <unsigned> class color_system>
  struct color : public color_value<color<ncomps, qbits, color_system> >
  {
    typedef int_u<qbits>		comp_type;
