...
/*!
  ...
  \param x1 An iterator.
  \param x2 An iterator.
...
# define for_all_4(x1, x2, x3, x4)  \
  for(x1.start(), x2.start(), x3.start(), x4.start(); \
      x1.is_valid(); \
      x1.next(), x2.next(), x3.next(), x4.next())
