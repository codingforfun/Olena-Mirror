...
#include <oln/lrde/ufmt/naive_generic_salembier.hh>
#include <oln/lrde/efigi/io.hh>


void usage(char* argv[])
{
  std::cerr << "Naive generic max-tree computation with salembier's flooding"
...
int main(int argc, char* argv[])
{
  ...
  typedef lrde::ufmt::naive_generic_salembier<image_t> algorithm_t;
