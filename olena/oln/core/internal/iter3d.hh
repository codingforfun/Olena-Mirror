...
namespace oln {
  ...
  namespace internal {
    ...
    class _iter3d : public type::any< _iter3d<Inferior> >
    {
    public:
      typedef Inferior inferior;
//       typedef _iter3d<Inferior> self;
...
//       }
      ...
      static std::string name() { return std::string("_iter3d<") + Inferior::name() + ">"; }
    ...
    protected:
      ...
      _iter3d(const image3d_size& size) :
	_nslices(size.nslices()),
	_nrows(size.nrows()),
	_ncols(size.ncols())
      {
...
#endif // ! OLENA_CORE_INTERNAL_ITER3D_HH
