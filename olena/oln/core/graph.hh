...
namespace oln {
  ...
  struct graph_traits
  {
    typedef mlc::undefined node_value_t;
    typedef mlc::undefined edge_value_t;
    typedef mlc::undefined nodes_set_t;
    typedef mlc::undefined edges_set_t;
    typedef mlc::undefined edges_of_node_set_t;
    typedef mlc::undefined neighbors_of_node_t;
    // hnode_t must be different to hedge_t.
    // handler are equivalent to unsigned.
    typedef mlc::undefined hnode_t;
    typedef mlc::undefined hedge_t;
    typedef mlc::undefined iterator;
  };
