...
funs << FunctionLoader.call('my_lib/lib.hh', 'foo1')
funs << FunctionLoader.call('my_lib/lib.hh', 'foo2', [], 'int*')
funs << FunctionLoader.call('my_lib/lib.hh', 'foo3',
                            ['double', 'const double', 'const double&'], 'double*')
funs << FunctionLoader.call('my_lib/lib.hh', 'my_lib::x::foo4',
