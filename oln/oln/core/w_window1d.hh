...
namespace oln {
  ...
  class w_window1d : public internal::_w_window< 1, T, typename type::exact_vt<w_window1d<T, Exact>, Exact>::ret >
  {
    typedef internal::_w_window< 1, T, typename type::exact_vt<w_window1d<T, Exact>, Exact>::ret > super;
  public:
