...
// to classes that have a private destructor, otherwise GCC will
// complain with
//   warning: `class X' only defines a private destructor and has no friends
//
// This GCC bug is known as PR/689.
...
#endif // ! OLENA_CORE_INTERNAL_FAKE_HH
