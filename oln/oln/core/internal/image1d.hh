...
namespace oln {
  ...
  namespace internal
  {
    ...
    class _image1d : public regular_image< 1, Exact>
    {
    public:

      typedef T value;
      typedef fwd_iter1d<type::final> iter;
      typedef fwd_iter1d<type::final> fwd_iter;
      typedef bkd_iter1d<type::final> bkd_iter;
