...
namespace oln {
  ...
  class w_window2d : public internal::_w_window< 2, T, typename type::exact_vt<w_window2d<T, Exact>, Exact>::ret >
  {
    typedef internal::_w_window< 2, T, typename type::exact_vt<w_window2d<T, Exact>, Exact>::ret > super;
  public:
