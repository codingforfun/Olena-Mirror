...
###
# $Format: "m4_define([OLN_VERSION], [0.$ProjectVersion$])"$
m4_define([OLN_VERSION], [0.7.61])
# $Format: "m4_define([OLN_MAJOR_VERSION], [0.$ProjectMajorVersion$])"$
m4_define([OLN_MAJOR_VERSION], [0.7])
